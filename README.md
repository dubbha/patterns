...
### Creational
- [ ] [factory](simple-factory.md) (aka "simple" factory) <sup>[⇗](https://refactoring.guru/design-patterns/factory-comparison) [⇗](https://en.wikipedia.org/wiki/Factory_(object-oriented_programming))</sup>
- [ ] mixin
- [ ] lazy initialization
